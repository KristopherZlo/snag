    ...
    <section>
        ...
        <div class="stack">
            ...
            <div class="surface">
                ...
                <div class="mono"><?php echo e(route('diagnostics.extension-recorder.ping')); ?></div>
            </div>
        </div>
    </section>
</main>
...
<script>
    (() => {
        ...
        const pingUrl = <?php echo json_encode(route('diagnostics.extension-recorder.ping'), 15, 512) ?>;
...
<?php /**PATH E:\xampp\htdocs\snag\apps\server\resources\views/diagnostics/extension-recorder.blade.php ENDPATH**/ ?>